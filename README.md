...
To set up the project locally inside a clean virtual environment, run git clone https://github.com/Mah96H/wikipedia-scraper.git and then go inside the folder using cd wikipedia-scraper.
